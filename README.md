...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/SyncArcs/terraform-google-template-instance/tree/master/example) directory within this repository.
